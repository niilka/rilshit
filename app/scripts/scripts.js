...
$(".tabs-controls").find("a").click(function () {
  if (!($(this).hasClass('active'))) {
    Array.from($(".tabs-controls").find("a")).forEach(function (el) {
      $(el).toggleClass('active');
      $(el).toggleClass('inactive');
      if ($('.profile-tab').hasClass('inactive')) {
        $('.tab-content.profile').css('display', 'none');
        $('.tab-content.settings').css('display', 'block');
      } else {
        $('.tab-content.profile').css('display', 'block');
